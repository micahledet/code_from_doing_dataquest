...
admissions.loc[admissions.index[0:129], "fold"] = 1
admissions.loc[admissions.index[129:258], "fold"] = 2
admissions.loc[admissions.index[258:387], "fold"] = 3
admissions.loc[admissions.index[387:515], "fold"] = 4
admissions.loc[admissions.index[515:], "fold"] = 5
...
train_iteration_one = admissions[admissions["fold"] != 1].copy()
test_iteration_one = admissions[admissions["fold"] == 1].copy()
